        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-glow-amber font-display text-lg font-bold text-amber-300">
            <Image
              ...
              width={28}
              height={28}
              className="mr-1 inline-block h-7 w-7 object-contain"
            />
          ...
          {days.map((day) => {
            ...
            return (
              <div key={day.date} className="flex flex-col items-center gap-1.5">
                ...
                >
                  {day.deposited ? (
                    <Image src="/assets/images/NormalStreak.png" alt="Deposit confirmed" width={28} height={28} className="h-7 w-7 object-contain" />
                  ) : d.getDate()}
                </div>
              </div>
            );
